...
export const moduleCQuestions: Question[] = [
  {
    ...
    "options": [
      ...
      "Recurrent Neural Network (RNN) thuần"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "Mạng CNN không thể xử lý ảnh màu RGB.",
      "Mô hình bị quá khớp (Overfitting) trên toàn bộ không gian dữ liệu.",
      "Data Drift / Domain Shift: Tập dữ liệu huấn luyện thiếu mẫu ảnh chụp ban đêm và thời tiết xấu.",
      "Hệ thống xe tự lái thiếu thuật toán sắp xếp mảng."
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Thay thế hoàn toàn kiến trúc Transformer bằng bảng băm.",
      "Tăng tốc độ sinh từ (token generation speed) lên 100 lần.",
      "Giảm hiện tượng ảo giác (Hallucination) và cập nhật kiến thức mới từ cơ sở dữ liệu nội bộ mà không cần huấn luyện lại toàn bộ mô hình.",
      "Nén dung lượng bộ nhớ GPU của mô hình xuống dưới 1MB."
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Algorithmic Bias (Thiên vị thuật toán) do dữ liệu lịch sử chứa định kiến nhân văn; giải pháp là kiểm toán dữ liệu (data audit), loại bỏ biến nhạy cảm và áp dụng Fairness Constraints.",
      "Overfitting mô hình; giải pháp là tăng số lượng epoch huấn luyện.",
      "Data Leakage; giải pháp là chia lại tập Train/Test theo tỷ lệ 50/50.",
      "Lỗi phần cứng máy chủ GPU; giải pháp là nâng cấp linh kiện."
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Dùng AI này tự tạo bài test cho AI khác mà không cần phản hồi của con người.",
      "Pre-training → Quantization → Pruning → Deployment.",
      "Chỉ thu thập dữ liệu con người rồi áp dụng Linear Regression.",
      "Supervised Fine-Tuning (SFT) → Huấn luyện Mô hình Phần thưởng (Reward Model) từ so sánh của con người → Tối ưu hóa chính sách bằng PPO."
    ],
    "correctAnswer": 3,
  ...
  },
  {
    ...
    "options": [
      "Hệ thống bị sập máy chủ khi có hàng triệu truy cập cùng lúc.",
      "Khó khăn khi đưa ra gợi ý chính xác cho người dùng mới hoặc sản phẩm mới chưa có lịch sử tương tác.",
      "Độ trễ quá lớn khi tính toán ma trận phân rã SVD.",
      "Thuật toán bị lặp lại duy nhất một nội dung gợi ý."
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "Vector Database (như Pinecone, Milvus, Chroma, Qdrant)",
      "Relational Database thuần (như SQLite không cài extensión)",
      "File văn bản txt lưu trên ổ đĩa",
  ...
  },
  {
    ...
    "options": [
      "Xóa bớt 99% từ vựng trong bảng Dictionary.",
      "Nén ảnh đầu vào xuống kích thước 1x1 pixel.",
      "Đóng băng (freeze) trọng số gốc của LLM và chèn thêm ma trận hạng thấp (low-rank matrices) có thể huấn luyện vào các lớp Attention.",
      "Chuyển đổi toàn bộ code Python sang C++ thủ công."
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Chỉ nhận diện được 1 vật thể duy nhất trong cả bức ảnh.",
      "Dự đoán tọa độ Bounding Box và nhãn lớp trong duy nhất một lần duyệt mạng (Real-time speed).",
      "Yêu cầu ảnh chụp phải có độ phân giải tối thiểu 8K.",
      "Không cần dùng mạng nơ-ron sâu."
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Cosine Distance của bảng chữ cái",
  ...
  },
  {
    ...
    "options": [
      "Mô hình không thể tính toán được khoảng cách",
      "Mô hình trở nên quá phẳng và bị Underfitting",
      "Tốc độ dự đoán sẽ chậm hơn nhiều",
      "Mô hình trở nên rất nhạy cảm với Nhiễu (Noise) và dễ bị Overfitting"
    ],
    "correctAnswer": 3,
  ...
  },
  {
    ...
    "options": [
      "Các Feature độc lập có điều kiện với nhau khi biết nhãn Class",
      "Các Feature phải tuân theo phân phối chuẩn",
      "Các Feature phải có mối quan hệ tuyến tính hoàn hảo",
      "Các Feature không được chứa dữ liệu dạng chuỗi"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Sử dụng Dropout",
      "Thêm dữ liệu huấn luyện hoặc Data Augmentation",
      "Tăng độ phức tạp của mô hình (thêm nhiều tầng/tham số)"
    ],
    "correctAnswer": 3,
  ...
  },
  {
    ...
    "options": [
      "Số lượng mẫu dữ liệu xử lý trong một bước cập nhật weights",
      "Một lần mô hình duyệt qua toàn bộ tập dữ liệu huấn luyện (Training Set)",
      "Tốc độ điều chỉnh độ dốc gradient",
      "Thời gian tính bằng giây để train một layer"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "Tập dữ liệu được chia thành đúng 32 phần bằng nhau",
      "Mô hình được huấn luyện trong 32 giây",
      "Số lượng mẫu dữ liệu được đưa vào xử lý trong một lần cập nhật tham số",
      "Mô hình có 32 lớp ẩn"
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Quá trình hội tụ có thể bị dao động hoặc phân kỳ (Diverge), không tìm được tối ưu",
      "Mô hình hội tụ cực kỳ nhanh và chính xác",
      "Mô hình lập tức bị Underfitting do dừng quá sớm",
      "Gradient bị biến mất hoàn toàn (Vanishing Gradient)"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Biến đổi logits thành phân phối xác suất cho bài toán phân loại nhiều lớp (Multi-class Classification)",
      "Tính trung bình cộng của các hidden units",
      "Triệt tiêu hoàn toàn các số âm về 0",
      "Tăng tốc độ tính toán gradient"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Tự động loại bỏ từ dừng (Stopwords)",
      "Thay thế hoàn bộ nhu cầu huấn luyện mô hình",
      "Cho phép mỗi Token tính toán mối quan hệ và sự liên quan với tất cả các Token khác trong chuỗi",
      "Giảm độ phức tạp tính toán xuống O(1)"
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Quick, Kernel, Variable",
      "Quantization, K-Means, Variance"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Độ dài của prompt đầu vào",
      "Tốc độ xử lý của phần cứng GPU",
      "Số lượng token tối đa trong ngữ cảnh",
      "Mức độ ngẫu nhiên và sáng tạo của câu trả lời"
    ],
    "correctAnswer": 3,
  ...
  },
  {
    ...
    "options": [
      "Temperature cao (ví dụ 0.9)",
      "Temperature thấp (ví dụ 0.1)",
      "Temperature = 2.0",
      "Không ảnh hưởng"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "Chỉ giữ lại K=20 token có xác suất cao nhất để lấy mẫu ở mỗi bước sinh từ",
      "Chỉ sinh ra tối đa 20 từ trong câu trả lời",
      "Lấy 20 câu trả lời tốt nhất từ mô hình",
      "Mô hình sẽ xem xét 20 câu hỏi gần nhất"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Chỉ lấy token có xác suất đúng bằng p",
      "Lấy cố định p phần trăm số token trong từ điển",
      "Chọn tập hợp các token nhỏ nhất có tổng xác suất tích lũy đạt ngưỡng p",
      "Bỏ qua p phần trăm số token hàng đầu"
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Loại bỏ hoàn toàn lớp Attention của Transformer",
      "Giữ nguyên trọng số gốc, chỉ huấn luyện một lượng nhỏ tham số ma trận hạng thấp bổ sung, tiết kiệm VRAM",
      "Tăng kích thước mô hình lên gấp 2 lần để thông minh hơn",
      "Cho phép chạy LLM không cần đến GPU"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "User Query → Safety Check → Fine-tune LLM → Output",
      "User Query → LLM → Retrieve Documents → Fine-tuning → Answer",
      "Retrieve Documents → User Query → Train Model → Output",
      "User Query → Retrieve Relevant Documents → Add Context → LLM → Answer"
    ],
    "correctAnswer": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Huấn luyện lại LLM từ đầu (Pretraining)",
      "Full Fine-tuning mô hình mỗi tuần",
  ...
  },
  {
    ...
    "options": [
      ...
      "Nén file văn bản thành định dạng ZIP",
      "Biểu diễn dữ liệu (từ, văn bản) thành các vector số thực trong không gian nhiều chiều",
      "Chuyển đổi văn bản sang mã SQL"
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Mô hình bịa ra thông tin sai sự thật nhưng trình bày một cách rất tự tin và hợp lý",
      "Mô hình không thể chạy được do thiếu GPU",
      "Mô hình phản hồi quá nhanh dẫn đến mất kết nối",
      "Mô hình trả về toàn các ký tự đặc biệt không đọc được"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Chỉ để kiểm thử lần cuối cùng trước khi đưa ra thị trường",
      "Để cập nhật weights trực tiếp bằng Gradient Descent",
      "Để đánh giá, lựa chọn mô hình và tinh chỉnh các Hyperparameter trong lúc huấn luyện",
      "Để gửi cho khách hàng xem thử"
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Tạo thêm các lớp Attention mới",
      "Tăng độ chính xác của mô hình lên gấp đôi",
      "Nén mô hình bằng cách giảm độ chính xác số thực của weights (ví dụ từ FP16 xuống INT8/INT4) để giảm bộ nhớ và tăng tốc",
      "Chuyển đổi văn bản sang dữ liệu âm thanh"
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "Hình ảnh / Thị giác máy tính",
      "Bảng biểu số liệu chứng khoán",
      "File ghi âm giọng nói 1D duy nhất",
  ...
  },
  {
    ...
    "options": [
      ...
      "Mã hóa lưu trữ dữ liệu trên Blockchain",
      "Chia nhỏ văn bản đầu vào thành các đơn vị nhỏ hơn (từ, cụm từ hoặc sub-words) tương ứng với các Token ID"
    ],
    "correctAnswer": 3,
  ...
  },
  {
    ...
    "options": [
      "Bỏ qua các dòng dữ liệu bị thiếu",
      "Tắt ngẫu nhiên một tỷ lệ các neuron trong quá trình huấn luyện",
      "Giảm tốc độ học xuống 0",
      "Xóa bớt các layer cuối"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "MAE lấy giá trị tuyệt đối của sai số, không phạt nặng các điểm dữ liệu ngoại lệ (outliers) như MSE",
      "MAE luôn có giá trị âm",
      "MAE chỉ dùng cho phân loại",
      "MAE bằng bình phương của MSE"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Số lượng kết quả tìm kiếm Google",
      "Kích thước màn hình ứng dụng Chat",
      "Giới hạn tổng số lượng token đầu vào và đầu ra tối đa mà mô hình có thể xử lý trong một lần truy vấn",
  ...
  },
  {
    ...
    "options": [
      "Prompt Engineering đắt đỏ hơn Fine-tuning",
      "Prompt Engineering chỉ thay đổi câu lệnh đầu vào mà không đổi weights; Fine-tuning cập nhật trọng số mô hình",
      "Fine-tuning không cần dùng GPU",
      "Prompt Engineering chỉ dành cho bài toán hình ảnh"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "BLEU score và ROUGE score",
      "Gigaflops và VRAM usage",
      "Temperature và Top-P",
      "Context Relevance (Độ liên quan ngữ cảnh) và Context Recall"
    ],
    "correctAnswer": 3,
  ...
  },
  {
    ...
    "options": [
      "Có, RAG cập nhật weight mỗi lần query",
      "Không, RAG chỉ bổ sung thông tin vào Prompt/Context",
      "Có, nhưng chỉ cập nhật layer cuối",
      "Tùy thuộc vào Vector DB"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "Tìm kiếm bối cảnh ngẫu nhiên trên Internet",
      "Tự suy đoán một quy định hợp lý",
      "Trả lời \"Tôi không tìm thấy thông tin trong tài liệu quy định hiện tại\"",
  ...
  },
  {
    ...
    "options": [
      "RAG kết hợp Vector DB lưu trữ tài liệu sản phẩm",
      "Chỉ dùng GPT-4 không cần cung cấp ngữ cảnh",
      "Huấn luyện mô hình KNN",
      "Dùng phương pháp Linear Regression"
    ],
    "correctAnswer": 0,
