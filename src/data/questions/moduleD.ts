...
export const moduleDQuestions: Question[] = [
  // ── Existing 12 questions ─────────────────────────────────────────────────
  {
    ...
    options: ["Một số người giỏi toán thích chơi cờ vua.", "Tất cả những người giỏi toán đều là kỹ sư AI.", "Tất cả những người thích chơi cờ vua đều giỏi toán.", "Không có người giỏi toán nào thích chơi cờ vua."],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Anonymization & Consent: Ẩn danh hóa thông tin cá nhân (PII) và được sự đồng ý rõ ràng của người dùng.", "Thu thập tối đa thông tin có thể mà không cần thông báo.", "Công khai toàn bộ dữ liệu thô lên mạng Internet.", "Lưu trữ dữ liệu vĩnh viễn không cho phép xóa."],
    correctAnswer: 0,
    ...
    tags: ["Data Privacy", "GDPR", "Đạo đức AI"]
  },
  {
    id: "modD_03",
    module: "D",
    ...
    options: ["Quyết định cuối cùng thuộc về bác sĩ (Human-in-the-loop); công cụ AI đóng vai trò tham vấn gợi ý, bác sĩ chịu trách nhiệm chuyên môn và có quyền ghi nhận/đối soát lại.", "Bắt buộc thực hiện phẫu thuật ngay lập tức theo quyết định của AI vì AI có độ chính xác cao hơn.", "Bỏ qua hoàn toàn kết quả của AI và xóa dữ liệu chẩn đoán.", "Cấu hình lại AI để tự động điều chỉnh kết quả trùng với ý kiến bác sĩ mà không cần kiểm chứng."],
    correctAnswer: 0,
    ...
    tags: ["Human-in-the-loop", "Medical Ethics", "Tình huống thực tế"]
  },
  {
    id: "modD_04",
    module: "D",
  ...
  },
  {
    ...
    options: ["Nhà sản xuất/Đơn vị phát triển hệ thống xe tự lái và phần mềm AI, tuân theo quy định an toàn xe cơ giới.", "Thuật toán AI tự chịu trách nhiệm hình sự.", "Người đi bộ bị đâm phải tự chịu trách nhiệm.", "Không ai chịu trách nhiệm vì đây là sự cố ngẫu nhiên."],
    correctAnswer: 0,
    ...
    tags: ["AI Governance", "Legal Responsibility", "Tình huống thực tế"]
  },
  {
    id: "modD_06",
    module: "D",
    ...
    options: ["Xâm phạm bản quyền tác giả (Fair Use vs. Copyright Infringement) và bóc lột lao động sáng tạo không đền bù fair compensation.", "Mô hình AI chạy quá chậm làm tiêu tốn điện năng.", "Các bức tranh quá đẹp khiến server bị quá tải.", "Họa sĩ vẽ tranh không tuân thủ cấu trúc dữ liệu JSON."],
    correctAnswer: 0,
    ...
    tags: ["Generative AI", "Copyright", "Deepfake Ethics", "Tình huống thực tế"]
  },
  {
    id: "modD_07",
    module: "D",
    ...
    options: ["17 phút", "19 phút", "21 phút", "15 phút"],
    correctAnswer: 0,
    ...
    tags: ["Logic Puzzle", "Tối ưu hóa thời gian"]
  },
  {
    id: "modD_08",
    module: "D",
    ...
    options: ["Adversarial Attack (Tấn công đối kháng / Perturbation)", "SQL Injection", "DDoS (Distributed Denial of Service)", "Phishing Email"],
    correctAnswer: 0,
    ...
    tags: ["Adversarial Attack", "AI Security", "Tình huống thực tế"]
  },
  {
    id: "modD_09",
    module: "D",
    ...
    options: ["Prompt Injection / Jailbreaking", "Buffer Overflow", "Cross-Site Scripting (XSS)", "Man-in-the-Middle Attack"],
    correctAnswer: 0,
    ...
    tags: ["Prompt Injection", "AI Safety", "Jailbreak"]
  },
  {
    id: "modD_10",
    module: "D",
    ...
    options: ["Nếu điểm số trên tập Test KHÔNG thấp thì mô hình KHÔNG bị Overfitting.", "Nếu điểm số trên tập Test thấp thì mô hình chắc chắn bị Overfitting.", "Nếu mô hình không bị Overfitting thì điểm số tập Test sẽ cao.", "Mô hình không bị Overfitting khi và chỉ khi điểm Train cao."],
    correctAnswer: 0,
    ...
    tags: ["Logic Mệnh đề", "Contrapositive"]
  },
  {
    id: "modD_11",
    module: "D",
    ...
    options: ["Tạm dừng ngay hệ thống sàng lọc AI, tiến hành kiểm toán tập dữ liệu huấn luyện lịch sử và xem xét lại các hồ sơ bị loại bằng quy trình rà soát con người.", "Tiếp tục sử dụng vì phần mềm đã giúp tiết kiệm 90% thời gian của bộ phận HR.", "Giảm tiêu chuẩn tuyển dụng đối với ứng viên nam.", "Xóa sạch dữ liệu lịch sử tuyển dụng để tránh bị kiện."],
    correctAnswer: 0,
    ...
    tags: ["AI Ethics", "HR Tech", "Algorithmic Bias"]
  },
  {
    id: "modD_12",
    module: "D",
    ...
    options: ["Hình tròn", "Hình sao", "Hình thoi", "Hình ngũ giác"],
    correctAnswer: 0,
  ...
  // ── NEW questions from user (renumbered from 13) ──────────────────────────
  {
    ...
    options: ["Không thể khẳng định chắc chắn A đúng hay sai", "A chắc chắn ĐÚNG", "A chắc chắn SAI", "A tương đương với B"],
    correctAnswer: 0,
    ...
    tags: ["logic", "propositional_logic"]
  },
  {
    id: "modD_14",
    module: "D",
    ...
    options: ["A chắc chắn SAI", "A chắc chắn ĐÚNG", "Không thể kết luận về A", "A và B cùng đúng"],
    correctAnswer: 0,
    explanation: "Theo nguyên lý phản đảo (Modus Tollens): A ⟹ B ≡ ¬B ⟹ ¬A. B sai nên A phải sai.",
    tags: ["logic", "modus_tollens"]
  },
  {
    id: "modD_15",
    module: "D",
    ...
    options: ["Ngụy biện khẳng định hệ quả (Affirming the Consequent) - Sai về mặt logic", "Suy luận diễn dịch hoàn toàn hợp lệ", "Quy nạp toán học đúng", "Ngụy biện bác bỏ tiền đề"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Số CCCD, Số điện thoại, Email, Địa chỉ nhà, Mật khẩu", "Nhiệt độ thời tiết trung bình hàng ngày", "Mã màu Hex của giao diện web", "Tổng số dòng code của dự án"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Dừng đưa dữ liệu trực tiếp vào Pipeline và tiến hành Masking/Anonymize (che/ẩn dữ liệu nhạy cảm)", "Tiếp tục train bình thường vì mô hình sẽ tự quên", "Xóa toàn bộ máy chủ dự án", "Đẩy dữ liệu lên GitHub công khai"],
    correctAnswer: 0,
    explanation: "Phải chặn luồng dữ liệu thô và áp dụng các biện pháp làm sạch/ẩn danh (Anonymization/Masking) PII lập tức.",
    tags: ["privacy", "pii", "data_pipeline"]
  },
  {
    id: "modD_18",
    module: "D",
    ...
    options: ["Cần kiểm tra nguồn gốc và bản quyền/giấy phép (License) của dữ liệu trước khi sử dụng", "Mọi dữ liệu trên Internet đều mặc định được tự do sử dụng thương mại", "Chỉ cần không ai phát hiện ra là được phép dùng", "Dữ liệu công khai thì không có bản quyền"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Mô hình đang bị Bias và thiếu tính Công bằng (Fairness)", "Mô hình bị Underfitting", "Mô hình chưa đủ số lượng tham số", "Mô hình đạt chuẩn đạo đức cao"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Hiển thị trích dẫn nguồn (Citation), cảnh báo AI có thể mắc sai sót và không trình bày AI như chuyên gia tuyệt đối", "Khẳng định 100% câu trả lời luôn chính xác tuyệt đối", "Ẩn nút Báo cáo lỗi (Report)", "Tăng kích thước chữ của phản hồi"],
    correctAnswer: 0,
    explanation: "Thiết kế UI trách nhiệm (Responsible UI) phải giúp người dùng nhận thức rủi ro và kiểm chứng thông tin dễ dàng.",
    tags: ["ui_ux", "hallucination", "product_ethics"]
  },
  {
    id: "modD_21",
    module: "D",
    ...
    options: ["Trình bày rõ ràng các rủi ro kèm bằng chứng từ test set, đề xuất phương án Rollout giới hạn hoặc thêm Human Review", "Lặng lẽ Deploy theo lệnh và không nói gì", "Sửa kết quả test lên 100% để quản lý vui", "Bỏ việc ngay lập tức không bàn giao"],
    correctAnswer: 0,
    ...
    tags: ["deployment", "ethics", "professionalism"]
  },
  {
    id: "modD_22",
    module: "D",
    ...
    options: ["Các bài toán có rủi ro cao như Chẩn đoán y tế hoặc Phê duyệt khoản vay tài chính lớn", "Phân loại Spam email cá nhân", "Gợi ý bài hát trên ứng dụng nghe nhạc", "Tự động chỉnh sửa lỗi chính tả văn bản đơn giản"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Cảnh báo độ tin cậy thấp và chuyển ca bệnh cho bác sĩ chuyên khoa xem xét trực tiếp", "Tự đoán bừa một căn bệnh phổ biến", "Bỏ qua không hiển thị ảnh X-quang", "Báo cáo ca bệnh hoàn toàn khỏe mạnh"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Theo dõi hiệu năng thực tế, phát hiện hiện tượng Data Drift / Concept Drift và truy vết lỗi rủi ro", "Tự động tăng gấp đôi số lượng GPU", "Thay thế hoàn toàn bộ phận chăm sóc khách hàng", "Xóa bớt dữ liệu lưu trữ để tiết kiệm đĩa"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Có ít nhất một mô hình AI không bị Overfit", "Tất cả các mô hình AI đều không bị Overfit", "Mọi mô hình AI đều bị Underfit", "Không có mô hình AI nào tồn tại"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Đảm bảo thông tin của một cá nhân không thể bị phân biệt với ít nhất K-1 cá nhân khác trong cùng dataset", "Tăng số lượng mẫu lên K lần", "Nén kích thước file dữ liệu xuống K phần trăm", "Chia dữ liệu thành K cụm bằng K-Means"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Prompt Injection / Jailbreaking", "Data Augmentation", "Fine-tuning Attack", "SQL Injection"],
    correctAnswer: 0,
    explanation: "Jailbreaking/Prompt Injection là thủ thuật lừa LLM bỏ qua các quy tắc đạo đức và an toàn được thiết lập.",
    tags: ["llm_security", "jailbreak"]
  },
  {
    id: "modD_28",
    module: "D",
    ...
    options: ["Vì Accuracy cao có thể đạt được bằng cách dự đoán rất tốt nhóm đa số trong khi sai hỏng nghiêm trọng ở nhóm yếu thế/thiểu số", "Vì Accuracy không tính được số thập phân", "Vì Accuracy chỉ áp dụng cho mô hình hồi quy", "Vì Accuracy thay đổi theo thời gian"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Chỉ thu thập và xử lý đúng những dữ liệu cá nhân thực sự cần thiết cho mục đích đã xác định", "Xóa toàn bộ dữ liệu sau 24 giờ", "Luôn thu thập càng nhiều dữ liệu càng tốt để train mô hình", "Chỉ lưu trữ dữ liệu dưới dạng số nguyên"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Con người / Nhà sản xuất và vận hành hệ thống AI", "Bản thân thuật toán AI", "GPU chứa mô hình", "Không ai chịu trách nhiệm"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Công bằng, Minh bạch, An toàn, Bảo mật riêng tư và Trách nhiệm giải trình", "Tối đa hóa lợi nhuận và giảm chi phí GPU", "Chỉ tập trung vào độ chính xác Accuracy", "Tự động hóa hoàn toàn không cần con người"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Làm sáng tỏ lý do mô hình đưa ra dự đoán cụ thể, giúp con người tin tưởng và kiểm toán quyết định của AI", "Tăng tốc độ inference của mô hình", "Giảm dung lượng bộ nhớ RAM", "Tự động viết code backend"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Nam chắc chắn biết Python", "Nam chưa chắc biết Python", "Nam chỉ biết Java", "Python là ngôn ngữ duy nhất Nam biết"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Đánh dấu nhận diện ẩn vào sản phẩm đầu ra để xác thực nội dung đó do AI tạo ra", "Tăng độ nét của hình ảnh", "Giảm dung lượng file xuống", "Tự động dịch sang tiếng Anh"],
    correctAnswer: 0,
    explanation: "Watermarking đóng tín hiệu nhận biết giúp kiểm duyệt và chống lan truyền tin giả từ AI sinh (Generative AI).",
    tags: ["watermarking", "genai"]
  },
  {
    id: "modD_37",
    module: "D",
    ...
    options: ["Ngăn chặn các đầu vào xấu/độc hại và kiểm duyệt các đầu ra vi phạm chính sách an toàn", "Tăng tốc độ sinh từ", "Lưu trữ cơ sở dữ liệu khách hàng", "Thay thế cho prompt của user"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Kẻ tấn công cố tình chèn dữ liệu độc hại/bị gắn nhãn sai vào tập huấn luyện để làm sai lệch hành vi mô hình", "Đánh sập máy chủ chứa mô hình bằng DDoS", "Chôm thông tin tài khoản ngân hàng của lập trình viên", "Xóa bỏ file weights trên ổ đĩa"],
    correctAnswer: 0,
    explanation: "Data Poisoning làm suy yếu hoặc cài cắm backdoor vào mô hình ngay từ giai đoạn huấn luyện dữ liệu.",
    tags: ["security", "data_poisoning"]
  },
  {
    id: "modD_40",
    module: "D",
    ...
    options: ["Thêm các nhiễu cực nhỏ không thể nhận biết bằng mắt người vào ảnh khiến mô hình phân loại sai hoàn toàn", "Ảnh có độ phân giải quá thấp", "Ảnh bị nén quá mức", "Ảnh bị xoay ngược 180 độ"],
    correctAnswer: 0,
    ...
    tags: ["security", "adversarial_attack"]
  },
  {
    id: "modD_41",
    module: "D",
    ...
    options: ["Mối quan hệ giữa thuộc tính đầu vào (Features) và nhãn mục tiêu (Target) bị thay đổi theo thời gian", "Kích thước file mô hình bị tăng lên", "Mô hình hết dung lượng đĩa", "Tốc độ mạng internet bị chậm"],
    correctAnswer: 0,
    explanation: "Concept Drift là khi bản chất mối quan hệ toán học giữa X và Y bị biến đổi do môi trường thực tế thay đổi.",
    tags: ["mlops", "concept_drift"]
  },
  {
    id: "modD_42",
    module: "D",
    ...
    options: ["Xâm phạm quyền riêng tư, định kiến xã hội và tước đoạt cơ hội của cá nhân mà không có cơ chế khiếu nại minh bạch", "Tốn quá nhiều điện năng", "Làm giảm số lượng ngân hàng", "Tăng tốc độ giao dịch quá nhanh"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Thường không được công nhận bản quyền vì thiếu tác giả là con người (Human authorship)", "Mặc định thuộc bản quyền của GPU sản xuất", "Thuộc bản quyền của chính mô hình AI đó", "Được cấp bản quyền vĩnh viễn tự động"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Rò rỉ bí mật công nghệ và vi phạm chính sách bảo mật dữ liệu của doanh nghiệp", "ChatGPT sẽ bị sập server", "Mã nguồn sẽ bị biến thành tiếng Pháp", "Không có rủi ro nào"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Tạo ra các \"Phòng vang thông tin\" (Echo Chambers), khiến người dùng chỉ nhìn thấy thông tin thiên lệch một chiều", "Giúp người dùng tiếp cận góc nhìn đa chiều hơn", "Tự động sửa lỗi chính tả tin tức", "Làm tăng tốc độ tải trang"],
    correctAnswer: 0,
    explanation: "Feedback loop liên tục củng cố sở thích cũ của người dùng, cô lập họ trong bóng tối thông tin (Echo Chamber).",
    tags: ["ethics", "echo_chamber"]
  },
  {
    id: "modD_46",
    module: "D",
    ...
    options: ["Chưa chắc đúng (Lỗi suy luận)", "Chắc chắn đúng", "Chắc chắn sai", "Trời không thể mưa"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Minh bạch khai báo việc sử dụng AI và chịu trách nhiệm hoàn toàn về độ chính xác của nội dung", "Giấu kín không cho ai biết", "Ghi tên AI là đồng tác giả chính", "Đổ lỗi cho AI nếu báo cáo có sai sót"],
    correctAnswer: 0,
    explanation: "Trách nhiệm học thuật yêu cầu minh bạch công cụ sử dụng và con người chịu trách nhiệm cuối cùng về nội dung.",
    tags: ["academic_integrity", "ethics"]
  },
  {
    id: "modD_48",
    module: "D",
    ...
    options: ["Mô hình chỉ cảnh báo khi cực kỳ chắc chắn => Precision tăng, nhưng Recall giảm (dễ bỏ sót gian lận hơn)", "Precision giảm và Recall tăng", "Cả Precision và Recall đều tăng", "Không ảnh hưởng tới chỉ số nào"],
    correctAnswer: 0,
    explanation: "Tăng ngưỡng dự đoán làm giảm FP (tăng Precision) nhưng tăng FN (giảm Recall).",
    tags: ["thresholds", "precision_recall_tradeoff"]
  },
  {
    id: "modD_49",
    module: "D",
    ...
    options: ["Một nhóm chuyên gia đóng vai kẻ tấn công nhằm cố tình tìm kiếm các lỗ hổng an ninh và lỗi của mô hình", "Nhóm lập trình viên vẽ giao diện màu đỏ", "Huấn luyện mô hình trên tập dữ liệu màu đỏ", "Tăng nhiệt độ GPU lên mức báo động"],
    correctAnswer: 0,
    explanation: "Red Teaming là phương pháp kiểm thử xâm nhập chuyên nghiệp để phát hiện các lỗ hổng tiềm ẩn của hệ thống AI.",
    tags: ["security", "red_teaming"]
  },
  {
    id: "modD_50",
    module: "D",
    ...
    options: ["Cả A và B đều SAI", "A ĐÚNG và B SAI", "A SAI và B ĐÚNG", "Cả A và B đều ĐÚNG"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["Tính minh bạch, độ tin cậy ổn định, bảo mật dữ liệu và có cơ chế xử lý khi AI trả lời sai", "Sử dụng mô hình có số lượng tham số lớn nhất thị trường bằng mọi giá", "Giao diện bóng bẩy nhiều hiệu ứng chuyển động", "Không bao giờ thừa nhận AI có thể mắc lỗi"],
    correctAnswer: 0,
    explanation: "Niềm tin người dùng đến từ sự minh bạch, an toàn dữ liệu và khả năng kiểm soát/sửa lỗi của hệ thống.",
    tags: ["product_ethics", "trust"]
  },
];
